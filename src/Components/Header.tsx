      ...
      <Nav variants={navVariants} initial={"top"} animate={navAnimation}>
          <Col>
            ...
            <Items>
                ...
                <Item>
                    <Link to="new">NEW! 요즘 대세인 콘텐츠 { newMatch && <Circle layoutId="circle" />}</Link>
                </Item>
            </Items>
          </Col>
            ...
            <Search onSubmit={handleSubmit(onValid)}>
                ...
                <Items>
                    <Item>Kids</Item>
                    <Item><FontAwesomeIcon icon={faBell}></FontAwesomeIcon></Item>
                    <Item_User>
                        <img style={{ width:"25px", height:"25px"}}src="https://nomadcoders.co/m.svg" alt=""/>
